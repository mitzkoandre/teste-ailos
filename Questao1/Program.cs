    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine();
                Console.Write("Entre o novo nome do titular da conta: ");
        ...
        private static void MostraDadosConta(ContaBancaria conta)
        {
            Console.WriteLine($"Conta {conta.Conta}, Titular: {conta.Titular}, Saldo: {conta.Saldo.ToString("$ #0.00")}");
        }
    }
}
